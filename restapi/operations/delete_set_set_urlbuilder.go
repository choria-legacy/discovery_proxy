...
func (o *DeleteSetSetURL) Build() (*url.URL, error) {
	...
	if set != "" {
		...
		return nil, errors.New("Set is required on DeleteSetSetURL")
	}
...
func (o *DeleteSetSetURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on DeleteSetSetURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on DeleteSetSetURL")
	}
